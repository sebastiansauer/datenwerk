...
* Falsch. Die lineare Regression $y=\alpha + \beta_1x_1 + \epsilon$ untersucht nur den Grad des *linearen* Zusammenhangs. Allerdings sind auch nicht-lineare Zusammenhänge von $y$ und den Prädiktoren erlaubt, etwa $y=\alpha + \beta_1x_1^2 + \beta_2x_2 + \epsilon$. *Linear* ist dabei so zu verstehen, dass $y$ eine additive Funktion der Prädiktoren ist. Vielleicht wäre es daher besser, anstelle von "linearen" Modellen von "additiven" Modellen zu sprechen.
