...
ACHTUNG: Das R-Paket `PupilPre` ist nur noch im [Archiv von CRAN](https://cran.r-project.org/src/contrib/Archive/PupilPre/) verfügbar und muss ggf. manuell installiert werden:
Einfach herunterladen und dann mit `install.packages("Pfad/zur/Datei/PupilPre_0.1.5.tar.gz", repos = NULL, type = "source")` installieren (oder über das Menü und dort bei "Install from" *Package Archive File* wählen).
