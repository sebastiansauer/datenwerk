...
```{r echo = FALSE}
sol <- parameters(m1, ci_method = "hdi", ci = .9, keep = "bill_length_mm")$Median
```

Die Lösung lautet also, wie aus der Ausgabe zu den Parametern ersichtlich, `r round(sol, 2)`.
