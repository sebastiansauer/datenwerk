...
Die Schnittmenge von $A$ und $B$ ist also $\{4,6\}$, 
also die Menge der geraden Zahlen, die größer als 3 sind.
Das sind 2 von 6 möglichen Ergebnissen, 
also ist die Wahrscheinlichkeit $P(A \cap B) = \frac{2}{6} = \frac{1}{3}$.
