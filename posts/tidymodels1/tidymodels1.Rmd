...
traindata_path_url  <- "/main/data/titanic/train.csv"
testdata_path_url <- "/main/data/titanic/test.csv"
...
rf_res2 <- 
  ...
  tune_grid(resamples = train_cv,
            grid = n_candidates,  # test 25 different tyining parameter values
