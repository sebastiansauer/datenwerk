...
Der Operator `&` steht für das logische "UND" (Union, Vereinigung).
...
$Pr(\neg A\cap B)$ ist im Prinzip identisch zur Union (Vereinigung) ohne Negation:
...
Um die Union von A und B auszurechnen, könnte man auch so vorgehen:
