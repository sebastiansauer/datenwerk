...
Laden Sie den Datensatz `toothgrowth`, in dem die Daten eines einfaches Experiments berichtet sind:


```{r}
data_url <- "https://vincentarelbundock.github.io/Rdatasets/csv/datasets/ToothGrowth.csv"

d <- read_csv("https://vincentarelbundock.github.io/Rdatasets/csv/datasets/ToothGrowth.csv")
