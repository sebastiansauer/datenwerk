...
Die Spalte `95% CI` gibt das 95%-Konfidenzintervall (CI wie *confidence interval*) zur Schätzung 
der Ungewissheit der Koeffizienten (der entsprechenden Zeile) wieder.  
