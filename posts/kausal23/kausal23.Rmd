...
Es ist also ein bisschen ein Spezialfall. Wie gesagt, der entscheidende Punkt ist, dass der Pfad "x5->x6" nicht kausal ist.

Natürlich ist das Beispiel extrem; niemand würde so einen DAG spezifizieren (normalerweise).
